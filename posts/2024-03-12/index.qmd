...
[MATLAB](https://www.mathworks.com/products/matlab/matlab-vs-python.html) themselves even write about the differences between MATLAB and Python and which is one you should use. It's true MATLAB's documentation on functions and packages is really extensive, easily understandable and takes the lead over Python and R. But this is just because MATLAB is a private company and the subscriptions aren't exactly cheap. For MATLAB they argue that you pay for more than just the GUI and software but also this user support (although I've never ever picked up the phone and called MATLAB directly with a problem I've had). 
